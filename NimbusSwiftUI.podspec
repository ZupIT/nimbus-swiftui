#
#  Be sure to run `pod spec lint NimbusSwiftUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = "Zup IT"
  # Or just: spec.author    = "Daniel Tes Carrasque"
  # spec.authors            = { "Daniel Tes Carrasque" => "daniel@zup.com.br" }
  # spec.social_media_url   = "https://twitter.com/Daniel Tes Carrasque"
